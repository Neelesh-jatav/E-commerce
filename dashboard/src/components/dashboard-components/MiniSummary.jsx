  ...
  const summary = [
    {
      ...
      subText: `This month's sales: INR ${(currentMonthSales * 89).toLocaleString()}`,
    ...
    },
    {
      ...
      subText: `Best Seller: ${topSellingProducts?.[0]?.name || 'N/A'} (${topSellingProducts?.[0]?.total_sold || 0} sold)`,
    ...
    },
    {
      ...
      subText: `Revenue ${revenueGrowth?.includes("+") ? "up" : "down"} by ${revenueGrowth || '0%'} compared to last month`,
