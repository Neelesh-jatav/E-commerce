...
const Cart = () => {
  ...
  // Updates cart item quantity or removes it if below 1
          ...
          <div className="lg:col-span-1">
            <div className="glass-panel sticky top-24">
              ...
              <div className="border-t border-[hsla(var(--glass-border))] pt-4">
                <div className="flex justify-between">
                  ...
                  <span className="text-lg font-semibold">
                    ${(total + (total >= 50 ? 0 : 2) + total * 0.18).toFixed(2)}
                  </span>
                </div>
              </div>
              <div className="space-y-4 mb-6 mt-6">
                ...
                <Link
                  to="/products"
                  className="w-full block text-center py-4 bg-secondary text-foreground rounded-lg animate-smooth font-semibold mb-4 border border-border hover:bg-accent"
                >
                  Continue Shopping
                </Link>
              </div>
