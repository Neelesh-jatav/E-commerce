...
const LoginModal = () => {
  ...
  const isAuthPopupOpen = useSelector((state) => state.popup.isAuthPopupOpen);
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative z-10 glass-panel w-full max-w-md mx-4 animate-fade-in-up">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {/* CONFIRM PASSWORD - ONLY VISIBLE FOR FOR RESET MODE */}
          {mode === "reset" && (
            <div className="relative">
              <User className="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-muted-foreground" />
              <input
        ...
        {["signin", "signup"].includes(mode) && (
          <div className="mt-6 text-center">
            <button
              ...
              className="text-primary hover:text-accent animate-none"
            >
              {mode === "signup"
