          ...
          >
            ...
            <div className="relative overflow-hidden rounded-lg mb-4">
              ...
              <button
                ...
                className="absolute bottom-3 right-3 p-2 rounded-full bg-primary/80 text-primary-foreground hover:bg-primary transition-colors opacity-0 group-hover:opacity-100"
              >
